...
public enum Colours {
     ...
     */
    TEAL(0.1, 50, new Color(0, 128, 128)),
    BROWN(0.1, 50, new Color(125, 70, 11)),
    PINK(0.2, 100, new Color(255,192,203)),
    ORANGE(0.3, 100, new Color(255,165,0)),
    RED(0.3, 150, new Color(255, 0, 0)),
    YELLOW(0.4, 150, new Color(255,255,0)),
    GREEN(0.4, 200, new Color(34,139,34)),
    BLUE(0.5, 200, new Color(0,0,255));
